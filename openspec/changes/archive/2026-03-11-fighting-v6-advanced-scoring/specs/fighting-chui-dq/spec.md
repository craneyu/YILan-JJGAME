...
Define SHIDO/CHUI foul counting (unified SHIDO counter), opponent score and WAZA-ARI assignment, automatic pending-DQ alert on SHIDO count ≥ 6, deduction rules that prevent negative scores, and the requirement that referee must still confirm the final decision.
