# Spec: jujitsu-match-management

## Purpose

Defines requirements for Admin to create, import, and manage Jiu-Jitsu competition match schedules (Ne-Waza, Fighting, Contact), and for the system to enforce match state transitions.
